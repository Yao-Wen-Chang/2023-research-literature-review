...
In the following three subsections, some attacks events and potential attack methods will be categories into 
the high-level representation of three main categories within the CI/CD pipeline. 
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \textbf{Remediation:}
        \begin{itemize}
            \item Continuously analyzed and mapped the identities' account to their permissions, and removed 
